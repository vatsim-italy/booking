...
A booking for the **{{ $booking->event->name }}** event has been requested. Check <a href="https://booking.vatita.net/admin/bookings/{{$booking->uuid}}/edit">here</a> for more information.
